...
public class NegocioCompra {
	...
	public ArrayList<Compra> ListarRecibidos(){
		...
		sql = "select oc.Cod_Compra as Compra, oc.Fecha as Fecha, oc.IGV as IGV, oc.Estado as Estado, t.ID as CodTrab, "
				...
				+ "pv.Telefono as TelProv, sum(dc.Cantidad * dc.Precio) as Subtotal  "
				+ "from Compra oc inner join Det_Comp dc on oc.Cod_Compra = dc.Cod_Compra inner join Trabajador t "
				+ "on oc.Cod_Trabajador = t.ID inner join Proveedor pv on oc.Cod_Proveedor = pv.ID WHERE oc.Estado = 1"
				+ " group by oc.Cod_Compra, oc.Fecha, oc.IGV, oc.Estado, t.ID , t.Nombre, t.Apellido, pv.ID, "
				+ "pv.Direccion, pv.Rz_Social, pv.Telefono";
	...
	public ArrayList<Compra> ListarPorRecibir(){
		...
		sql = "select oc.Cod_Compra as Compra, oc.Fecha as Fecha, oc.IGV as IGV, oc.Estado as Estado, t.ID as CodTrab, "
				...
				+ "pv.Telefono as TelProv, sum(dc.Cantidad * dc.Precio) as Subtotal  "
				+ "from Compra oc inner join Det_Comp dc on oc.Cod_Compra = dc.Cod_Compra inner join Trabajador t "
				+ "on oc.Cod_Trabajador = t.ID inner join Proveedor pv on oc.Cod_Proveedor = pv.ID WHERE oc.Estado = 0"
				+ " group by oc.Cod_Compra, oc.Fecha, oc.IGV, oc.Estado, t.ID , t.Nombre, t.Apellido, pv.ID, "
				+ "pv.Direccion, pv.Rz_Social, pv.Telefono ";
	...
	//Modifica los parametros y también recibe el pedido de ser necesario
	...
	public ArrayList<Compra> getCompraByID(String cod){
		ArrayList<Compra> lista = new ArrayList<Compra>();
	...
	public ArrayList<Compra> getComprasByID(String patron){
		ArrayList<Compra> lista = new ArrayList<Compra>();
		...
		sql = "select oc.Cod_Compra as Compra, oc.Fecha as Fecha, oc.IGV as IGV, oc.Estado as Estado, t.ID as CodTrab, "
				...
				+ "pv.Telefono as TelProv, sum(dc.Cantidad * dc.Precio) as Subtotal  "
				+ "from Compra oc inner join Det_Comp dc on oc.Cod_Compra = dc.Cod_Compra inner join Trabajador t "
				+ "on oc.Cod_Trabajador = t.ID inner join Proveedor pv on oc.Cod_Proveedor = pv.ID WHERE oc.Cod_Compra like ? "
				+ "group by oc.Cod_Compra, "
				+ "oc.Fecha, oc.IGV, oc.Estado, t.ID , t.Nombre, t.Apellido, pv.ID, pv.Direccion, pv.Rz_Social, pv.Telefono";
	...
	public ArrayList<Compra> getComprasByProv(String patron){
		ArrayList<Compra> lista = new ArrayList<Compra>();
		...
		sql = "select oc.Cod_Compra as Compra, oc.Fecha as Fecha, oc.IGV as IGV, oc.Estado as Estado, t.ID as CodTrab, "
				...
				+ "pv.Telefono as TelProv, sum(dc.Cantidad * dc.Precio) as Subtotal  "
				+ "from Compra oc inner join Det_Comp dc on oc.Cod_Compra = dc.Cod_Compra inner join Trabajador t "
				+ "on oc.Cod_Trabajador = t.ID inner join Proveedor pv on oc.Cod_Proveedor = pv.ID WHERE pv.Rz_Social like ? "
				+ "group by oc.Cod_Compra, "
				+ "oc.Fecha, oc.IGV, oc.Estado, t.ID , t.Nombre, t.Apellido, pv.ID, pv.Direccion, pv.Rz_Social, pv.Telefono";
