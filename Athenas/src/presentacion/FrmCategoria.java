...
public class FrmCategoria extends JDialog implements ActionListener {
	...
	protected void actionPerformedBtnModificar(ActionEvent arg0) {
		if (!txtCodigo.getText().equals("")) {
			...
			JOptionPane.showMessageDialog(this, "Debe seleccionar un registro para realzar esta acción",
	...
	protected void actionPerformedBtnGuardar(ActionEvent arg0) {
		if(comon.ValidaTexto(txtDescripcion.getText())){
			...
			JOptionPane.showMessageDialog(this, "Descripción inválida", "Error de ingreso de datos", JOptionPane.ERROR_MESSAGE);
	...
	protected void actionPerformedBtnEliminar(ActionEvent arg0) {
		if (!tblCategoria.getSelectionModel().isSelectionEmpty()) {
			int confirmar = JOptionPane.showConfirmDialog(this, "¿Desea eliminar este regitro?", "Precaución",
			...
			if (confirmar == JOptionPane.YES_OPTION) {
				...
				txtCodigo.setText("");
				txtDescripcion.setText("");
				JOptionPane.showMessageDialog(this, "Registro eliminado", "Confirmación",
