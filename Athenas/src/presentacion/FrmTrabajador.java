...
public class FrmTrabajador extends JInternalFrame implements KeyListener, ActionListener {
	...
	private boolean ValidaDatos() {
		...
		if (!comon.ValidaTexto(txtNombre.getText())) {
			...
			JOptionPane.showInternalMessageDialog(this, "Formato de email erróneo");
			txtCorreo.grabFocus();
			...
			JOptionPane.showInternalMessageDialog(this, "El usuario no puede estar vacío");
			txtUsuario.grabFocus();
		} else if (txtContrasenia.getText().length() < 1) {
			JOptionPane.showInternalMessageDialog(this, "La contraseña no puede estar vacía");
