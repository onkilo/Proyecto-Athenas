...
public class FrmTrabajador extends JInternalFrame implements KeyListener, ActionListener {
	...
	public FrmTrabajador() {
		...
		panel.setBorder(new TitledBorder(null, "Trabajador", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(59, 59, 59)));
		getContentPane().add(panel, "cell 0 0,grow");
		panel.setLayout(new MigLayout("", "[150px:n,grow][grow]", "[30px:n][30px:n][30px:n][30px:n][30px:n][30px:n][30px:n][30px:n][30px:n][30px:n][30px:n][]"));
		...
		panel_1.setBorder(new TitledBorder(null, "Listado de trabajadores", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(59, 59, 59)));
